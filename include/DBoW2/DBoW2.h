...
/// Semantic ORB Vocabulary
typedef DBoW2::TemplatedVocabulary<DBoW2::FSORB::TDescriptor, DBoW2::FSORB>
  SemanticOrbVocabulary;

/// FSORB Database
typedef DBoW2::TemplatedDatabase<DBoW2::FSORB::TDescriptor, DBoW2::FSORB>
  SemanticOrbDatabase;
